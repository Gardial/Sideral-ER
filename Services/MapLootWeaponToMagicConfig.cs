...
public sealed class MapLootWeaponToMagicConfig
{
    ...
    public List<MapLootWeaponToMagicEntry> Entries { get; init; } = new();
}

public sealed class MapLootWeaponToMagicEntry
{
    public int OldItemId { get; init; }
    public int OldItemCategory { get; init; } = 2;
}

public sealed class MapLootWeaponToMagicRunResult
{
    ...
    public int EligibleMapLootRowCount { get; init; }
    public List<MapLootWeaponToMagicRunMapping> Mappings { get; init; } = new();
}

public sealed class MapLootWeaponToMagicRunMapping
{
